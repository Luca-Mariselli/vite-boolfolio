        ...
        <div class="my-projects-box">
            <div class="my-projects-item" v-for="project in projects.data">
                <a href="#" class="my-courses-item_link">
                    ...
                    <div v-if="project.img.startsWith('http')" style="min-height: 200px;"><img :src="project.img" alt=""
                            style="z-index: 99; position: relative;" width="200"></div>
                    <div v-else style="min-height: 200px;"><img :src="base_url + 'storage/' + project.img" alt=""
                            style="z-index: 99; position: relative;" width="200"></div>
